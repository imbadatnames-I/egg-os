...
print("> ")
print("> ")
print(">                                            Stir Stick(R) Mxes OS (R) Version 0.58.30.8")
...
>"""
        ...
        while not end:
            ...
            if money_op=="1":
                ...
                with open("c:\\operating systems\\mxes os\\costs","a") as file:
                    file.write(f"{cost}\n")
            if money_op=="2":
            ...
            if money_op=="5":
                ...
                if tot_money>0:
                    print(f"\033[1;323;48m> You have {tot_money} dollars =){ansi_escape}")
            if money_op=="6":
                end=True
    elif program=="version finder":
        code_len=int(input("> How meny characters is the code?\n"))
