...
def get_user_info():
                    if os.path.exists("c:\\os\\operating systems\\mxes os\\user_info.txt"):
                        with open("c:\\os\\operating systems\\mxes os\\c:\\os\\operating systems\\mxes os\\user_info.txt", "r") as file:
...
while not end:
    ...
    if money_op=="2":
        ...
        with open("c:\\os\\operating systems\\mxes os\\c:\\os\\operating systems\\mxes os\\costs","r") as file:
