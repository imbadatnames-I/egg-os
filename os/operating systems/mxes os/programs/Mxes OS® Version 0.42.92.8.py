...
current_entry = []
keywords=["task manager","shutdown","text doc","password manager","clock","journal","math","standby","text style","help","guess the number","settings","recipe","dice"]
def get_user_info():
...
print("> ")
print("> ")
print(">                                              Stir Stick(R) Mxes OS (R) Version 0.99")
