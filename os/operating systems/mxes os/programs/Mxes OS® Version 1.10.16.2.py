...
keywords=["task manager","shutdown","text doc","password manager","clock","journal","math","standby","text style","help","guess the number","settings","recipe","dice","wordle","money","version finder","project","unit"]
def get_user_info():
...
print("> ")
print("> ")
print(">                                            Stir Stick® Mxes OS® Version 1.10.16.2")
