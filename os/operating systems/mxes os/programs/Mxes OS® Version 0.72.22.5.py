...
while running==True:
        ...
        if program=="standby":
                ...
                while not end:
                    ...
                    if journal_input == "$end$":
                        ...
                        try:
                            with open("c:\\operating systems\\mxes os\\journal", "r") as file:
                        ...
                        if current_entry:
                            with open("c:\\operating systems\\mxes os\\journal", "a") as file:
        ...
        >"""
                ...
                with open("c:\\operating systems\\mxes os\\words.txt", "r") as file:
                ...
                while not end:
                    ...
                    if money_op=="2":
                        ...
                        with open("c:\\operating systems\\mxes os\\costs","r") as file:
                            ...
                            int (costs_num)
                            costs_num-=cost_less
                            with open("c:\\operating systems\\mxes os\\c:\\operating systems\\mxes os\\costs","w") as file:
                    ...
                    if money_op=="3":
                        ...
                        with open("c:\\operating systems\\mxes os\\c:\\operating systems\\mxes os\\money","a") as file:
                            file.write(f"{pay}\n")
                    if money_op=="4":
                        if tts_mode=="t":
                                    engine = pyttsx3.init()
                        ...
                        with open("c:\\operating systems\\mxes os\\money","r") as file:
                            ...
                            int (money_num)
                            money_num-=pay_less
                            with open("c:\\operating systems\\mxes os\\c:\\operating systems\\mxes os\\money","w") as file:
