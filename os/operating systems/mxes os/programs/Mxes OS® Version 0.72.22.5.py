...
system_files=[]
user_files=[]
os_file="Mxes OS® Version fill version.py"
ansi_escape = "\033[1;32;48m"
keywords=["task manager","shutdown","text doc","password manager","clock","journal","math","standby","text style","help","guess the number","settings","recipe","dice","wordle","money","version finder","project","unit","startup","idle","file","version imp","version open","contact"]
program="startup"
while running==True:
        import os
        import shutil
        ...
        if program=="startup":
            ...
            print("> ")
            print("> ")
            print(">                                            Stir Stick® Mxes OS® Version 0.67.68.1")
        ...
        if program=="standby":
                ...
                while not end:
                    import time
                    current_time_utc = time.gmtime()  # Get current time in UTC
                    current_time_cst = time.localtime(time.mktime(current_time_utc) - (6 * 3600))  # Convert to CST
                ...
                if end==False:
                    ...
                    print(">   unit: a unit converter that can do Temperature, Weight, and Length")
                    print(">   startup: startup is the program that makes the user data and is the startup.")
                    print(">   idle: waits for exit input then ends.")
                    print(">   files: files shows you all files and lets you delete non system files.")
                    print("    version imp: lets you import old versions of mxes os.")
                    print("    version open: lets you run mxes os versions in the main mxes os folder after importing it from version imp")
                    print("> ")
                    end=True
        ...
        >"""
                ...
                while not end:
                    ...
                    if money_op=="1":
                        ...
                        with open("c:\\os\\operating systems\\mxes os\\c:\\os\\operating systems\\mxes os\\costs","a") as file:
                            file.write(f"{cost}\n")
                    if money_op=="2":
                        if tts_mode=="t":
                                    engine = pyttsx3.init()
                        ...
                        with open("c:\\os\\operating systems\\mxes os\\costs","r") as file:
                            ...
                            int (costs_num)
                            costs_num-=cost_less
                            with open("c:\\os\\operating systems\\mxes os\\c:\\os\\operating systems\\mxes os\\costs","w") as file:
                    ...
                    if money_op=="3":
                        ...
                        with open("c:\\os\\operating systems\\mxes os\\c:\\os\\operating systems\\mxes os\\money","a") as file:
                            file.write(f"{pay}\n")
                    if money_op=="4":
                        if tts_mode=="t":
                                    engine = pyttsx3.init()
                        ...
                        with open("c:\\os\\operating systems\\mxes os\\money","r") as file:
                            ...
                            int (money_num)
                            money_num-=pay_less
                            with open("c:\\os\\operating systems\\mxes os\\c:\\os\\operating systems\\mxes os\\money","w") as file:
                ...
                while not end:
                    if tts_mode=="t":
                                    ...
                                    engine.runAndWait()
                    unedited_version=int(input("> How meny characters are in the code?\n> "))*.00001
                    multiple=.00001
        ...
        elif base64_string=="cHJvamVjdA==":
                while not end:
                    end=True
        elif program=="unit": # form now on there is no tts
            CONVERSIONS = {
            "length": {
                "m_to_km": 0.001,
                "km_to_m": 1000,
            ...
            program="standby"
              ...
              while not end:
                idle=input("> input exit to leave.\n> ")
                if idle=="exit":
                    end=True
        elif program=="version imp":
            while not end:
        ...
        elif program=="version open":
            while not end:
                file_name=input(f"> What is the name of the file you want to open? warning the only way to leave the old version is to end the whole program to leave here input {os_file}\n> ")
                with open(file_name) as f:
                    code = f.read()
                    exec(code)
        elif program=="file":
            expected_system_files = {"mxes os startup.wav", "Mxes OS® Version fill version.py",".vscode",".venv","__pycache__","words.txt","Mxes OS (R) Version 0.22.15.6.py","Mxes OS® Version 0.14.78.8.py","Mxes OS® Version 0.22.15.6.py","Mxes OS® Version 0.41.32.8.py","Mxes OS® Version 0.42.43.6.py","Mxes OS® Version 0.42.92.8.py","Mxes OS® Version 0.48.13.4.py","Mxes OS® Version 0.48.60.6.py","Mxes OS® Version 0.52.58.8.py","Mxes OS® Version 0.58.30.8.py","Mxes OS® Version 0.97.15.6.py","Mxes OS® Version 1.10.16.2.py"}
            ...
            def add_name():
                    ...
                    with open("c:\\os\\operating systems\\mxes os\\contact.txt", "a") as file:
                # Check if the file is empty
                        file.seek(0, 2)  # Move to the end of the file
                        if file.tell() != 0:  # If file is not empty
                            file.write("\n")  # Add newline if not the first task
            ...
            def delete_contact():
                    ...
                    with open("c:\\os\\operating systems\\mxes os\\contact.txt", "r") as file:
                        lines = file.readlines()  # Read all lines from the file
                    with open("c:\\os\\operating systems\\mxes os\\contact.txt", "w") as file:
